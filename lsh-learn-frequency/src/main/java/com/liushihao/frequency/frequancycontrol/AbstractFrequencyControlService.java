package com.liushihao.frequency.frequancycontrol;

import com.liushihao.frequency.dto.FrequencyControlDTO;
import com.liushihao.frequency.exception.CommonErrorEnum;
import com.liushihao.frequency.exception.FrequencyControlException;
import com.liushihao.frequency.utils.AssertUtil;
...
public abstract class AbstractFrequencyControlService<K extends FrequencyControlDTO> {
     ...
     * 单限流策略的调用方法-编程式调用
     *
     * @param frequencyControl 单个频控对象x
